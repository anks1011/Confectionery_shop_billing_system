							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button  class="btn btn-sm btn-primary edit_category" data-id="<?php echo $row['id'] ?>" type="button" data-description="<?php echo $row['description'] ?>" data-name="<?php echo $row['name'] ?>" data-toggle="modal" data-target="#exampleModal">Edit</button>
