			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of bills </b>
						<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="billing/index.php" >
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$order = $conn->query("SELECT * FROM bills order by unix_timestamp(date_created) desc ");
