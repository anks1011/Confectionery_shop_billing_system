...
<?php 
if(isset($_GET['id'])):
$order = $conn->query("SELECT * FROM bills where id = {$_GET['id']}");
foreach($order->fetch_array() as $k => $v){
    $$k= $v;
}
$items = $conn->query("SELECT o.*,p.name FROM billed_items o inner join products p on p.id = o.product_id where o.bill_id = $id ");
endif;
?>
	...
	<div class="row mt-3 ml-3 mr-3">
        <div class="col-lg-4">
           <div class="card border-dark">
                <div class="card-header text-white  border-dark">
                    <b>Make Bill</b>
                <span class="float:right"><a class="btn btn-s btn-sm col-sm-3 float-right" href="../index.php" id="">
            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-white" id='o-list'>
                            <div class="d-flex w-100 bg-dark mb-1">
                                <label for="" class="text-white"><b>Bill No.</b></label>
                                <input type="number" class="form-control-sm" name="bill_number" value="<?php echo isset($bill_number) ? $bill_number : '' ?>" required>
                            </div>
        ...
        <div class="col-lg-8  p-field">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="card c prod-item" data-json = '<?php echo json_encode($row) ?>' data-category-id="<?php echo $row['category_id'] ?>">
                                    <div class="card-body">
                                        <span><b class="text-white">
                                            <?php echo $row['name'] ?>
                                        </b></span>
            ...
            <div class="card-footer bg-dark  border-primary">
                <div class="row justify-content-center">
                    <div class="btn btn btn-sm col-sm-3 btn-primary mr-2" type="button" id="pay">Print and Pay</div>
                    </div>
            </div>
            </div>      			
        </div>
