...
<nav id="sidebar" class='sidebar1 mx-lt-5 ' >
		
		<div class="sidebar-list">
				<a href="index.php?page=home" class="nav-item nav-home"><span class='icon-field'><i class="fa fa-tachometer-alt "></i></span> Dashboard</a>
				<a href="index.php?page=bills" class="nav-item nav-bills"><span class='icon-field'><i class="fa fa-clipboard-list "></i></span> Bills</a>
				<a href="billing/index.php" class="nav-item nav-takebills"><span class='icon-field'><i class="fa fa-list-ol "></i></span> Make bills</a>
